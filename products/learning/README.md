...
Topics roughly track the milestone they're first introduced in, but most concepts get *reused* across many milestones — once you learn IAM in M0, you'll use it every milestone after.
...
| 25 | **Indexing** — B-tree, partial, multi-column, covering, when *not* to index | ☐ | — |
...
| 61 | **Signaling** — out-of-band, why it's *not* part of WebRTC, our WS reuse | ☐ | — |
